...
print("set1과 set2가 동일한지:", set1 == set2) #순서가 달라도 같다고 나옴
print(set1.intersection(set2)) # set1과 set2의 교집합만 출력
...
for idx in range(1, 101):
    ...
    lotto_numbers, lotto_bonus_number = generate_lotto_numbers()  
    check_winner(lotto_numbers, lotto_bonus_number, winning_numbers)
